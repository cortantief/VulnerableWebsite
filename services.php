    ...
    <div class="container">
      <div class="row centered">
        <div class="col-lg-8 col-lg-offset-2">
          <h4>NOUS SAVONS FAIRE PLEIN DE CHOSES</b></h4>
          <p>REGARDEZ ET CONTACTEZ NOUS !</p>
        </div>
      </div>
      <!-- row -->
    </div>
  ...
  <div class="container w">
    <div class="row centered">
      ...
      <div class="col-lg-4">
        ...
        <p>Des sites web dynamiques de qualité.</p>
      </div>
      <!-- col-lg-4 -->
      ...
      <div class="col-lg-4">
        <i class="fa fa-eye"></i>
        <h4>SEO SERVICES</h4>
        <p>Promotion de votre site pour arriver en tête des référencements.</p>
      </div>
      <!-- col-lg-4 -->
    </div>
    <!-- row -->
    ...
    <div class="row centered">
      ...
      <div class="col-lg-4">
        ...
        <h4>SOCIAL MEDIA</h4>
        <p>Création de réseaux sociaux</p>
      </div>
      <!-- col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <h4>E-COMMERCE</h4>
        <p>Création de toute part d'e-shop.</p>
      </div>
      <!-- col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <p>Backup "tar *" dans notre cloud!</p>
      </div>
      <!-- col-lg-4 -->
    </div>
    <!-- row -->
      ...
      <div class="row centered">
        ...
        <div class="col-lg-4">
          ...
          <div class="pricing-option">
            ...
            <a href="index.php#" class="pricing-signup">Choisir</a>
          </div>
          <!-- /pricing-option -->
          <!-- END PRICING TABLE -->
        </div>
